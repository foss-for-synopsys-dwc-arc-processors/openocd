...
static const struct arc32_reg_desc arc32_regs_descriptions[ARC_TOTAL_NUM_REGS] = {
	...
	/* AUX */
	{ ARC_REG_PC,               "pc",       PC_REG_ADDR,       REG_TYPE_CODE_PTR, false, 64, },
	{ ARC_REG_LP_START,         "lp_start", LP_START_REG_ADDR, REG_TYPE_CODE_PTR, false, 65, },
	{ ARC_REG_LP_END,           "lp_end",   LP_END_REG_ADDR,   REG_TYPE_CODE_PTR, false, 66, },
	{ ARC_REG_STATUS32,         "status32", STATUS32_REG_ADDR, REG_TYPE_UINT32, false, 67, },
...
struct reg_cache *arc_regs_build_reg_cache(struct target *target)
{
	...
	struct reg_data_type *data_types[13] = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
		uint32_data_type, NULL, NULL, code_ptr_data_type, data_ptr_data_type };
